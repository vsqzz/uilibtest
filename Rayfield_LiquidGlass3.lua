...
--[[
    ============================================
    ✨ Rayfield Theme Extension: LiquidGlass ✨
    ============================================
    Elegant frosted-glass UI applied only to the Rayfield interface.
...
getgenv().RayfieldThemes["LiquidGlass"] = function(MainFrame, ThemeOptions)
    ...
    BlurLayer.Name = "GlassBlurLayer"
    BlurLayer.BackgroundTransparency = 1
    BlurLayer.Image = "rbxassetid://8992230677" -- blurred texture
    BlurLayer.ImageTransparency = 0.4
    BlurLayer.ScaleType = Enum.ScaleType.Stretch
